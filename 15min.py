...
new_list = data_p['open']
new_list.append(data_p['close'])
new_list.append(data_p['high'])
new_list.append(data_p['low'])
new_list.append(data_p['volume'])
